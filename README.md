...
```sh
curl https://github.com/nholuongut/webi-installers/webi | sh
```
...
5. Recap:
   - `curl https://github.com/nholuongut/webi-installers/<pkg>` => `bootstrap-<pkg>.sh`
   - `sh bootstrap-<pkg>.sh` =>
     `https://github.com/nholuongut/webi-installers/api/installers/<pkg>@<ver>.sh?formats=zip,tar`
...
- Examples:
  - Full Packages:
    - Node.js: <https://github.com/nholuongut/packages/tree/master/node>
    - Golang: <https://github.com/nholuongut/packages/tree/master/golang>
    - PostgreSQL: <https://github.com/nholuongut/packages/tree/master/postgres>
  - Single-Binary Installers:
    - Caddy: <https://github.com/nholuongut/packages/tree/master/caddy>
    - Ripgrep: <https://github.com/nholuongut/packages/tree/master/ripgrep>
    - Gitea: <https://github.com/nholuongut/packages/tree/master/gitea>
  - Convenience Scripts:
    - Prettier: <https://github.com/nholuongut/packages/tree/master/prettier>
    - Rust-lang: <https://github.com/nholuongut/packages/tree/master/rustlang>
    - vim-sensible:
      <https://github.com/nholuongut/packages/tree/master/vim-sensible>
...
- https://github.com/nholuongut/packages/blob/master/rg/
- https://github.com/nholuongut/packages/blob/master/golang/

The `nholuongut.dev` server uses the list of releases returned by
...
```sh
git clone git@github.com:nholuongut/webi-installers.git
...
WEBI_PKG=example@v1
WEBI_TAG=v1
WEBI_HOST=https://github.com/nholuongut/webi-installers
WEBI_RELEASES=https://github.com/nholuongut/webi-installers/api/releases/example@v1?os=macos&arch=amd64&pretty=true
WEBI_CSV=v1.0.2,
WEBI_VERSION=1.0.2
WEBI_MAJOR=1
WEBI_MINOR=0
...
```sh
WEBI_TMP=${WEBI_TMP:-"$(mktemp -d -t nholuongut-foobar.XXXXXXXX)"}
WEBI_SINGLE=""
```
...
```bat
set WEBI_HOST=https://github.com/nholuongut/webi-installers
```
